...
public class WelcomeScreen extends JFrame {
	...
	public void setRegisterButton() {
		...
		myRegisterButton.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				} else if (myDatabase.checkIfUsernameAlreadyExists(myRegisterAccount.getText())) {
	...
	private void logInAction(boolean isValidUser) {
		if (!isValidUser) {
			...
			//
			new MainScreen(myDatabase.getUser(myLogAccount.getText()));
			dispose();
		}
	}
	...
	private boolean findUser() {
		...
		for(GeneralUser user: myDatabase.getUsers()) {
